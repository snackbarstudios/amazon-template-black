...
export default function createOrganizationApi(_ref) {
  ...
  function getOrganizationMemberships() {
    ...
    return http.get('organization_memberships', createRequestConfig({ query: query })).then(function (response) {
  ...
  function getTeamMemberships() {
    ...
    var query = _get(opts, 'query', {});
    if (opts.teamId) {
      return http.get('teams/' + opts.teamId + '/team_memberships', createRequestConfig({ query: query })).then(function (response) {
        return wrapTeamMembershipCollection(http, response.data);
      }, errorHandler);
    }
    return http.get('team_memberships', createRequestConfig({ query: query })).then(function (response) {
      return wrapTeamMembershipCollection(http, response.data);
    }, errorHandler);
  }
  ...
  function getTeamSpaceMemberships() {
    ...
    return http.get('team_space_memberships', createRequestConfig({ query: query })).then(function (response) {
  ...
  function getTeams() {
    ...
    return http.get('teams', createRequestConfig({ query: query })).then(function (response) {
