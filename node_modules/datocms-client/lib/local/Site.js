...
var _faviconTagsBuilder = _interopRequireDefault(require("../utils/faviconTagsBuilder"));
...
function () {
  ...
  _createClass(Site, [{
    ...
    value: function toMap() {
      ...
      var fields = ['id', 'name', 'locales', 'theme', 'domain', 'internalDomain', 'noIndex', 'globalSeo', 'favicon', 'faviconMetaTags'];
    ...
    value: function readAttribute(attribute, TypeKlass, localized) {
      var value = (0, _localizedRead["default"])(this.entity, attribute, localized, _i18n["default"]);
    ...
    key: "globalSeo",
    get: function get() {
      return this.readAttribute('globalSeo', _GlobalSeo["default"], this.locales.length > 1);
    }
  }, {
    key: "favicon",
    get: function get() {
