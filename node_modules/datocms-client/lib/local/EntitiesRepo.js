  ...
  _createClass(EntitiesRepo, [{
    ...
    value: function upsertEntities() {
      ...
      payloads.forEach(function (payload) {
        payloadEntities(payload).forEach(function (entityPayload) {
          var entity = new _JsonApiEntity["default"](entityPayload, _this3);
          entities.push(entity);
          _this3.entities[entity.type] = _this3.entities[entity.type] || {};
          _this3.entities[entity.type][entity.id] = entity;
        });
      });
    ...
    value: function destroyEntities(type, ids) {
      ...
      ids.forEach(function (id) {
        if (_this4.entities[type] && _this4.entities[type][id]) {
          entities.push(_this4.entities[type][id]);
          delete _this4.entities[type][id];
        }
      });
