...
function () {
  ...
  _createClass(Client, [{
    ...
    value: function put(url, body) {
      ...
      return this.request(this.buildUrl(url, params), _objectSpread({
        method: 'PUT',
    ...
    value: function request(url) {
      ...
      var fullHeaders = _objectSpread({}, this.defaultHeaders(), {}, this.extraHeaders, {}, options.headers);

      var fullOptions = _objectSpread({}, options, {
        headers: fullHeaders
